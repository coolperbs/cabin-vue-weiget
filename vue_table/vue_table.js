...
define('waresys/lib/vue_table/vue_table', function (require, exports, module) {
  ...
  var component = {
    ...
    methods: {
       ...
       * 表格点击
       */
      fieldClick: function fieldClick(param) {
        var fieldItem = param.fieldItem;
        var dataItem = param.dataItem;
        var e = param.e; // console.log(fieldItem,dataItem);
      ...
      changeActive: function changeActive(otherParam) {
        this.curCol = otherParam.colIndex;
        this.curRow = otherParam.rowIndex;
      },
      fieldTitleClick: function fieldTitleClick(param) {
        var fieldItem = param.fieldItem;
        var self = this;
      ...
      addExtClass: function addExtClass() {
        var config = this.config;
        var className = "";
      ...
      * 页面切换
      */
      changePage: function changePage(param) {
    ...
    mounted: function mounted() {
      this.refresh();
      this.render(); // {'table-hover':!config.nonHover,'non-border':config.nonBorder,'table-top-bordered':!config.nonBorder, 'table-bottom-bordered'}
      // debugger;
    }
  };
  return component;
